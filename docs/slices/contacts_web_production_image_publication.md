...
4. confirm the two references are distinct and stable
5. confirm the BFF reference preserves the production port expectation
6. confirm the handoff is explicit enough for `../infra-platform`
