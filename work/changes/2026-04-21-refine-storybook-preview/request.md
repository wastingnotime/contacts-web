...
The most valuable next story coverage is the set of edge states that are otherwise awkward to inspect quickly: loading, empty, validation, error, and submit-pending states on the list and form surfaces, plus page-level create and edit previews that do not require the app router to be running.
