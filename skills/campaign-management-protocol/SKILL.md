...
When a campaign starts from a finding, use the `cross-repo-findings` skill and the supporting guidance in [`docs/operating/cross_repo_findings_guidance.md`](../../docs/operating/cross_repo_findings_guidance.md). The finding workflow stays authoritative for discovery and ownership; this skill only coordinates the campaign that follows.
